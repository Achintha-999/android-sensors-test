...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    private Sensor accelerometer, light, proximity, magnetic;

    private TextView textAccelerometer, textLight, textProximity, textMagnetic;
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        switch (sensorType) {
            case Sensor.TYPE_ACCELEROMETER:
                ...
                textAccelerometer.setText(format);
                break;
            ...
            case Sensor.TYPE_MAGNETIC_FIELD:
                textMagnetic.setText(String.valueOf(event.values[0]));
                break;
        }
